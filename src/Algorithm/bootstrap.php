...
require __DIR__ . DIRECTORY_SEPARATOR . 'reduce.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'skip.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'slice.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'string_iterator.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'take.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'to_iterator.php';
